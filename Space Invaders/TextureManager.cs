...
{
    private const string ASSETS_PATH = @"C:\Users\Lenovo-PC\RiderProjects\Space Invaders\Space Invaders\Assets";

    private const string BACKGROUND_TEXTURE_PATH = @"\Backgrounds\starfieldBG.png";

    private const string PLAYER_TEXTURE_PATH = @"\Ships\playerShip3_red.png";
